...
## Project Structure
    ...
    ├── white_limit_dev_105916  # Django project configurations
...
1. Clone this repo and `cd white_limit_dev_105916`
...
2. Clone this repo and `cd white_limit_dev_105916`
