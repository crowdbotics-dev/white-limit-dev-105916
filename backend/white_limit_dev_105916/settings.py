"""
Django settings for white_limit_dev_105916 project.
...
ROOT_URLCONF = 'white_limit_dev_105916.urls'
...
WSGI_APPLICATION = 'white_limit_dev_105916.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "white_limit_dev_105916 API",
    "DESCRIPTION": "API documentation for white_limit_dev_105916 App",
    "VERSION": "v1",
}
